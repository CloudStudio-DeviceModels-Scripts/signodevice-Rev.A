...
# Parsing + Configuration Script – signo_device - Rev. A

This **Parsing + Configuration** script is designed for the **signo_device** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – signo_device Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **signo_device** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
